...
TID_PARAM=" -t 32524"
# path to folders
TMPDIR=/scratch/!TODO/omark_run/ # set here the tmp folder in the cluster
SIBBSS_PATH=$(realpath $PWD/../../)  # assuming we are in Module1/src/
MODULE1_PATH=${SIBBSS_PATH}/Module1_AnnotationQuality
COMMONDATA_PATH=${SIBBSS_PATH}/CommonData
INPUT_FOLD=${COMMONDATA_PATH}/minidataset/proteome/

# activate right conda environment !TODO
#source /users/spascare/miniconda3/envs/eukaryoma/bin/activate
